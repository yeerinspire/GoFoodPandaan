...
class PilihMapsTujuanActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pilih_maps_tujuan)
        ...
        mFusedLocationProviderClient =
            LocationServices.getFusedLocationProviderClient(this@PilihMapsTujuanActivity)
        Places.initialize(this@PilihMapsTujuanActivity, getString(R.string.google_maps_key))
        ...
        btn_accept.setOnClickListener(View.OnClickListener {
            ...
            rippleBg!!.startRippleAnimation()
                IkiOjekActivity.latitudetujuan = latitude.toString()
                IkiOjekActivity.longitudetujuan = longitude.toString()
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        val settingsClient = LocationServices.getSettingsClient(this@PilihMapsTujuanActivity)
        val task =
            settingsClient.checkLocationSettings(builder.build())

        task.addOnSuccessListener(
            this@PilihMapsTujuanActivity,
            OnSuccessListener<LocationSettingsResponse?> { getDeviceLocation() })

        task.addOnFailureListener(this@PilihMapsTujuanActivity,
            OnFailureListener { e ->
                if (e is ResolvableApiException) {
                    try {
                        e.startResolutionForResult(this@PilihMapsTujuanActivity, 51)
