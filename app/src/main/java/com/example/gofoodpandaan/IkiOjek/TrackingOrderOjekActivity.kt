...
*/
                    val refrating =
                        FirebaseDatabase.getInstance().getReference("Pandaan").child("Costumers")
                            .child(UserID.toString()).child("statusrating").setValue(true)
                    val refdriverid =
                        FirebaseDatabase.getInstance().getReference("Pandaan").child("Costumers")
                            .child(UserID.toString()).child("ratingdriver").setValue(uiddriver.toString())
